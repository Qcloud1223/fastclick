...
//JiffieClock()
fdIN0 :: FromDump(/mnt/traces/caida.pcap-1, STOP true, TIMING true, TIMING_FNT "", END_AFTER 0, ACTIVE true, BURST 1);
...
fdIN0-> limit0   :: Counter(COUNT_CALL 100000000 ender.run) -> [0]rr

elementclass Generator { $magic |
input
  -> replay :: Pipeliner(BLOCKING true, CAPACITY 1024, ALWAYS_UP true)
  -> MarkMACHeader
-> EnsureDPDKBuffer
...
StaticThreadSched(gen0/replay 0/1);
rr[0] -> gen0;
...
tsd :: HandlerAggregate( ELEMENT RIN/tsd0 );
